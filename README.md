...
class Development(Config):
    OWNER_ID = 1173808065  # my telegram ID
    OWNER_USERNAME = "Shareef"  # my telegram username
    API_KEY = "your bot api key"  # my api key, as provided by the botfather
    SQLALCHEMY_DATABASE_URI = 'postgresql://username:password@localhost:7733/database'  # sample db credentials
